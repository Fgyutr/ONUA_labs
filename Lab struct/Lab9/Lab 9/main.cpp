...
//Побудувати бінарне дерево пошуку з вхідної послідовності цілих чисел. Обчислити добуток значень всіх листків.
//Ввести число. Визначити, чи присутнє це число в дереві, створеному в Завданні 1. Видалити знайдений елемент. Продемонструвати для листка, вузла з одним піддеревом, вузла з двома піддеревами.
